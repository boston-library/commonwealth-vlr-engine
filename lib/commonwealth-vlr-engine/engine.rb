...
module CommonwealthVlrEngine
  class Engine < Rails::Engine
    ...
    #Blacklight::Configuration.default_values[:index].document_actions = nil # don't show bookmark control # setting to nil in Engine makes app puke, not sure why, as was fine in local app?
    ...
    Blacklight::Configuration.default_values[:default_solr_params] = {:qt => 'search', :rows => 20}

    # solr field configuration for search results/index views
    Blacklight::Configuration.default_values[:index].title_field = 'title_info_primary_tsi'
    Blacklight::Configuration.default_values[:index].display_type_field = 'active_fedora_model_suffix_ssi'

    # facets
    Blacklight::Configuration.default_values[:facet_fields] = {
