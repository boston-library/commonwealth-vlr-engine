...
Gem::Specification.new do |s|
  ...
  s.add_dependency 'blacklight_iiif_search', '~> 3.1'
  ...
  s.add_dependency 'rails', '>= 7.2.2', '< 9'
  s.add_dependency 'recaptcha', '~> 5.17'
  s.add_dependency 'rsolr', '>= 1.0', '< 3'
  s.add_dependency 'rss', '~> 0.3.1'
  s.add_dependency 'typhoeus', '~> 1.4'
  s.add_dependency 'zipline', '~> 2.2.0'

  s.add_development_dependency 'axe-core-capybara', '~> 4.11'
  s.add_development_dependency 'axe-core-rspec', '~> 4.11'
