...
Gem::Specification.new do |s|
  ...
  # s.add_dependency 'omniauth-polaris' moved to gemfile until released on ruby gems
  s.add_dependency 'unicode'
  s.add_dependency 'madison', '~> 0.5.0'
  s.add_dependency 'iiif-presentation', '~> 0.2.0'
  s.add_dependency 'zipline'

  s.add_development_dependency 'omniauth', '~> 1.8.1'
  s.add_development_dependency 'omniauth-ldap', '~> 2.0.0'
  s.add_development_dependency 'omniauth-facebook', '~> 5.0.0'
  s.add_development_dependency 'devise-guests', '~> 0.6.0'
